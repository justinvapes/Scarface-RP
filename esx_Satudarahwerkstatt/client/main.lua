...
AddEventHandler('esx:playerLoaded', function(xPlayer)
	...
	ESX.TriggerServerCallback('esx_satudarahwerkstatt:getVehiclesPrices', function(vehicles)
		Vehicles = vehicles
	end)
end)
...
RegisterNetEvent('esx_satudarahwerkstatt:installMod')
AddEventHandler('esx_satudarahwerkstatt:installMod', function()
	local vehicle = GetVehiclePedIsIn(PlayerPedId(), false)
	myCar = ESX.Game.GetVehicleProperties(vehicle)
	TriggerServerEvent('esx_satudarahwerkstatt:refreshOwnedVehicle', myCar)
end)

RegisterNetEvent('esx_satudarahwerkstatt:cancelInstallMod')
AddEventHandler('esx_satudarahwerkstatt:cancelInstallMod', function()
	local vehicle = GetVehiclePedIsIn(PlayerPedId(), false)
...
function OpenLSMenu(elems, menuName, menuTitle, parent)
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), menuName,
	{
		...
		for k,v in pairs(Config.Menus) do
			...
			if k == data.current.modType or isRimMod then
				...
				if data.current.label == _U('by_default') or string.match(data.current.label, _U('installed')) then
					...
					TriggerEvent('esx_satudarahwerkstatt:installMod')
				else
					...
					if isRimMod then
						...
						TriggerServerEvent('esx_satudarahwerkstatt:buyMod', price)
		...
		menu.close()
		TriggerEvent('esx_satudarahwerkstatt:cancelInstallMod')
