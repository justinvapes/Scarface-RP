...
AddEventHandler('esx:playerLoaded', function(xPlayer)
	...
	ESX.TriggerServerCallback('scarface_cardealercustom:getVehiclesPrices', function(vehicles)
		Vehicles = vehicles
	end)
end)
...
RegisterNetEvent('scarface_cardealercustom:installMod')
AddEventHandler('scarface_cardealercustom:installMod', function()
	local vehicle = GetVehiclePedIsIn(PlayerPedId(), false)
	myCar = ESX.Game.GetVehicleProperties(vehicle)
	TriggerServerEvent('scarface_cardealercustom:refreshOwnedVehicle', myCar)
end)

RegisterNetEvent('scarface_cardealercustom:cancelInstallMod')
AddEventHandler('scarface_cardealercustom:cancelInstallMod', function()
	local vehicle = GetVehiclePedIsIn(PlayerPedId(), false)
...
function OpenLSMenu(elems, menuName, menuTitle, parent)
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), menuName,
	{
		...
		for k,v in pairs(Config.Menus) do
			...
			if k == data.current.modType or isRimMod then
				...
				if data.current.label == _U('by_default') or string.match(data.current.label, _U('installed')) then
					...
					TriggerEvent('scarface_cardealercustom:installMod')
				else
					...
					if isRimMod then
						...
						TriggerServerEvent('scarface_cardealercustom:buyMod', price)
		...
		menu.close()
		TriggerEvent('scarface_cardealercustom:cancelInstallMod')
...
Citizen.CreateThread(function()
	while true do
		...
		if IsPedInAnyVehicle(playerPed, false) then
			...
			if (PlayerData.job and PlayerData.job.name == 'cardealer') or not Config.IscardealerJobOnly then
				for k,v in pairs(Config.Zones) do
