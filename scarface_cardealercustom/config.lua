...
Config.Locale            = 'de'
Config.IscardealerJobOnly = true

Config.Zones = {

	cardealer = {
		Pos   = { x = -775.04, y = -232.76,z = 36.72},
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {5.95, 10.56, 20.12, 40.53}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {2.65, 4.3, 8.6, 13.95}
	},
	modTransmission = {
		label = _U('transmission'),
		parent = 'upgrades',
		modType = 13,
		price = {4.95, 8.93, 12.51}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {1.72, 3.44, 5.88, 7.77, 11.2}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {15.77, 30.28, 45.00, 90.00, 180.00, 190.00}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
