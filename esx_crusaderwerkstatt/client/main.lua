...
AddEventHandler('esx:playerLoaded', function(xPlayer)
	...
	ESX.TriggerServerCallback('esx_crusaderwerkstatt:getVehiclesPrices', function(vehicles)
		Vehicles = vehicles
	end)
end)
...
RegisterNetEvent('esx_crusaderwerkstatt:installMod')
AddEventHandler('esx_crusaderwerkstatt:installMod', function()
	local vehicle = GetVehiclePedIsIn(PlayerPedId(), false)
	myCar = ESX.Game.GetVehicleProperties(vehicle)
	TriggerServerEvent('esx_crusaderwerkstatt:refreshOwnedVehicle', myCar)
end)

RegisterNetEvent('esx_crusaderwerkstatt:cancelInstallMod')
AddEventHandler('esx_crusaderwerkstatt:cancelInstallMod', function()
	local vehicle = GetVehiclePedIsIn(PlayerPedId(), false)
...
function OpenLSMenu(elems, menuName, menuTitle, parent)
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), menuName,
	{
		...
		for k,v in pairs(Config.Menus) do
			...
			if k == data.current.modType or isRimMod then
				...
				if data.current.label == _U('by_default') or string.match(data.current.label, _U('installed')) then
					...
					TriggerEvent('esx_crusaderwerkstatt:installMod')
				else
					...
					if isRimMod then
						...
						TriggerServerEvent('esx_crusaderwerkstatt:buyMod', price)
		...
		menu.close()
		TriggerEvent('esx_crusaderwerkstatt:cancelInstallMod')
