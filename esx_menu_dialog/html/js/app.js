		...
		'<div id="menu_{{_namespace}}_{{_name}}" class="dialog text-center {{#isBig}}big{{/isBig}}">' +
			'<div class="card text-white bg-dark mb-3 ">'+
				...
				'<div class="card-body">'+
					...
					'<div class="row">'+	
						'<div class="col-sm-6">'+	
							'<button type="button" class="btn btn-success btn-sm btn-block text-center" name="submit">Bestätigen</button>' +
						'</div>' +
						'<div class="col-sm-6">'+	
							'<button type="button" class="btn btn-danger btn-sm btn-block text-center" name="cancel">Abbrechen</button>'+
						'</div>' +
					'</div>' +
				'</div>' +
			'</div>' +
