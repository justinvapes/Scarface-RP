Locales['fi'] = {
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~b~mechanic~s~',
  -- Vehicle interaction
  ...
  ['quantity'] = 'määrä',
  ['inventory'] = 'varasto',
  ['mechanic_stock'] = 'poliisin Varasto',
  -- Misc
  ...
  -- Notifications
  ['alert_mechanic'] = 'hälyytys Poliisi',
  ['phone_mechanic'] = 'poliisi',
}