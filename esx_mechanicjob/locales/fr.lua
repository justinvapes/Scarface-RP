Locales['fr'] = {
  ...
  ['being_searched'] = 'vous êtes ~y~recherché(e)~s~ par la ~b~mechanic~s~',
  -- Vehicle interaction
  ...
  ['mechanic_stock'] = 'coffre de la mechanic',
  -- Misc
  ...
  -- Notifications
  ['alert_mechanic'] = 'alerte mechanic',
