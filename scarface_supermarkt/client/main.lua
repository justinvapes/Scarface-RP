...
Citizen.CreateThread(function()
    ...
    ESX.TriggerServerCallback('scarface_shops:loadItems', function(items)
...
RegisterNUICallback('buy', function(data, cb)
    ...
    ESX.TriggerServerCallback('scarface_shops:canAfford', function(bool)
        if bool then
...
-- Citizen.CreateThread(function()
--     while true do
--     N_0x4757f00bc6323cfe(GetHashKey("WEAPON_ADVANCEDRIFLE"), 0.7) 
