Locales['de'] = {
  ...
  ['gave_weapon_ammo'] = 'du gibst ~o~%sx %s~s~ für ~b~%s~s~ an ~y~%s~s~',
  ['gave_weapon_withammo'] = 'du gibst ~b~%s~s~ mit ~o~%sx %s~s~ an ~y~%s~s~',
  ['gave_weapon_hasalready'] = '~y~%s~s~ hat bereits eine(n) ~y~%s~s~',
  ['gave_weapon_noweapon'] = '~y~%s~s~ hat nicht diese Waffe',
  ['received_weapon'] = 'du erhälst ~b~%s~s~ von ~b~%s~s~',
  ['received_weapon_ammo'] = 'du erhälst~o~%sx %s~s~ für deine ~b~%s~s~ von ~b~%s~s~',
  ...
  ['received_weapon_noweapon'] = '~b~%s~s~ hat versucht dir Munition für ~y~%s~s~, zu geben aber du hast die Waffe nicht',
  ...
  ['threw_standard'] = 'Du hast weggeworfen ~y~%sx~s~ ~b~%s~s~',
  ['threw_money'] = 'Du hast weggeworfen ~g~$%s~s~ ~b~$~s~',
  ['threw_account'] = 'Du hast weggeworfen ~g~$%s~s~ ~b~%s~s~',
  ['threw_weapon'] = 'Du hast weggeworfen ~b~%s~s~',
  ['threw_weapon_ammo'] = 'Du hast weggeworfen ~b~%s~s~ mit ~o~%sx %s~s~',
  ['threw_weapon_already'] = 'Du hast bereits dieselbe Waffe',
  ['threw_cannot_pickup'] = 'Du kannst das nicht aufheben weil deine Taschen voll sind!',
  ['threw_pickup_prompt'] = 'drücke ~y~E~s~ zum Aufheben',

  -- Key mapping
  ['keymap_showinventory'] = 'Zeige Inventar',
  ...
  ['in_vehicle'] = 'Du kannst nichts in einem Fahrzeug weitergeben',
  ...
  ['component_clip_box'] = 'Box Munition',
  ['component_flashlight'] = 'Taschenlampe',
  ['component_scope'] = 'Visier',
  ['component_scope_advanced'] = 'Erweitertes Visier',
  ['component_suppressor'] = 'Schalldämpfer',
  ['component_grip'] = 'Waffengriff',
  ['component_luxary_finish'] = 'Waffenlackierung',
