...
RegisterNUICallback('Durchsuchen', function(data, cb)
    toggleField(false)
	TriggerEvent("Craniax_Fraktion:durchsuchen")
end)

RegisterNUICallback('Fesseln', function(data, cb)
    toggleField(false)
	TriggerEvent("Craniax_Fraktion:fesseln")
end)

RegisterNUICallback('Kofferraum', function(data, cb)
    toggleField(false)
	TriggerEvent('Craniax_Trunk:opentrunk')
end)
